...
extern void _XimpSendByClientMessage(XIMPCore, CARD32, char *, int);
extern void _XimpSendByProperty(XIMPCore, long, char *, int);
extern void _XimpSendIMProtocol(XIMPCore, XimpClient *, int,
                unsigned long, unsigned long,
                unsigned long, unsigned long);
extern Bool _XimpSetMatch(XimpClient *, CARD32, CARD32, CARD32);
extern Bool _XimpProcessMatch(XimpClient *, CARD32, CARD32, CARD32);
...
extern int _XimpGeometryCallback(XIMS, IMPProtocol *);
extern int _XimpPreeditStartCallback(XIMS, IMPProtocol *);
extern int _XimpPreeditDoneCallback(XIMS, IMPProtocol *);
extern int _XimpPreeditDrawCallback(XIMS, IMPProtocol *);
extern int _XimpPreeditDrawCMCallback(XIMS, IMPProtocol *);
extern int _XimpPreeditCaretCallback(XIMS, IMPProtocol *);
extern int _XimpStatusStartCallback(XIMS, IMPProtocol *);
extern int _XimpStatusDoneCallback(XIMS, IMPProtocol *);
extern int _XimpStatusDrawCallback(XIMS, IMPProtocol *);
extern int _XimpStatusDrawCMCallback(XIMS, IMPProtocol *);
...
extern Bool _XimpSetMatch();
extern Bool _XimpProcessMatch();
...
extern int _XimpGeometryCallback();
extern int _XimpPreeditStartCallback();
extern int _XimpPreeditDoneCallback();
extern int _XimpPreeditDrawCallback();
extern int _XimpPreeditDrawCMCallback();
extern int _XimpPreeditCaretCallback();
extern int _XimpStatusStartCallback();
extern int _XimpStatusDoneCallback();
extern int _XimpStatusDrawCallback();
extern int _XimpStatusDrawCMCallback();
