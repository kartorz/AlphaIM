...
IMForwardEventStruct *call_data;
{
	...
	char *text = "samleIM commit string 中文";
	char lang[20];
...
int MyProtoHandler(ims, call_data)
XIMS ims;
IMProtocol *call_data;
{
    printf("MyProtoHandler 0x%x\n", call_data->major_code);
...
char **argv;
{
    ...
    IMGetIMValues(ims,
		  ...
		  NULL);
    XSelectInput(dpy, im_window, StructureNotifyMask|ButtonPressMask|KeyPressMask);
