...
**
****************************************************************************/
#ifndef QAIMPLATFORMINPUTCONTEXT_H
#define QAIMPLATFORMINPUTCONTEXT_H
...
class QAimFilterEventWatcher: public QDBusPendingCallWatcher
{
public:
    explicit QAimFilterEventWatcher(const QDBusPendingCall &call,
                                     QObject *parent = 0,
                                     QWindow *window = 0,
...
class QAimPlatformInputContext : public QPlatformInputContext
{
    Q_OBJECT
public:
    QAimPlatformInputContext();
    ~QAimPlatformInputContext();
...
private:
    QAimPlatformInputContextPrivate *d;
